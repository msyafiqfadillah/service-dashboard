...
class Airend_rotary extends CI_Controller {
    ...
    public function index() {
        ...
        $this->load->view('layout/site_tpl', array(
            ...
            "active_menu" => "spareparts/airend_rotary",
            "content" => "spareparts/airend_rotary",
            "data" => array(
                "get_airend_rotary_url" => site_url('spareparts/airend_rotary/get_data'),
